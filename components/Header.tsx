  ...
  return (
    <>
      ...
      <div className="bg-bmw-dark h-9 flex items-center justify-end px-6 gap-5">
        <Link href="/login" className="text-xs text-gray-400 hover:text-white">Verkäufer-Login</Link>
      </div>
      ...
      <header className="bg-white border-b border-bmw-gray-border">
        <div className="max-w-layout mx-auto px-6 h-16 flex items-center gap-8">
          ...
          <nav className="ml-auto flex gap-6">
            <Link href="/" className="text-[13px] text-bmw-gray-text font-medium hover:text-bmw-blue">Modelle</Link>
            <Link href="/login" className="text-[13px] text-bmw-gray-text font-medium hover:text-bmw-blue">Verkäufer</Link>
          </nav>
        </div>
      </header>
    </>
